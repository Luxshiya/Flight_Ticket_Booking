<!-- resources/views/booking_confirmation.blade.php -->
@extends('layouts.app')
...
<main id="main">
    ...
    <div class="container">
        ...
        @if (!$booking->is_paid)
            ...
            @else
            <!-- Add the "View Bookings" button here with the booking ID parameter -->
            <a href="{{ route('user.dashboard') }}" class="btn btn-success">View Bookings</a>
